JSROOT={BIT:function(a){return 1<<a}};var jscsg;JSROOT.define=function(a,b){1==a.length?jscsg=b(THREE):b(THREE,jscsg)};importScripts("three.min.js","JSRoot.csg.js","JSRoot.geobase.js");console&&console.log("geoworker started three.js r"+THREE.REVISION);var clones=null;
