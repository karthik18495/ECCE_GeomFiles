...
new ArrayBuffer(0),0):d.provideData(f,b);7<d.ackn&&d.send("READY",0)}},b._websocket.onclose=function(a){delete d._websocket;if(0<d.state||"force_close"===a)console.log("websocket closed"),d.state=0,d.invokeReceiver(!0,"onWebsocketClosed")},b._websocket.onerror=function(a){console.log("websocket error "+a+" state "+d.state);0<d.state&&(d.invokeReceiver(!0,"onWebsocketError",a),d.state=0)},JSROOT.batch_mode||setTimeout(l,3E3))}};l(!0)};JSROOT.connectWebWindow=function(a){"function"==typeof a?a={callback:a}:
a&&"object"==typeof a||(a={});if(a.prereq)return a.openui5src&&(JSROOT.openui5src=a.openui5src),a.openui5libs&&(JSROOT.openui5libs=a.openui5libs),a.openui5theme&&(JSROOT.openui5theme=a.openui5theme),JSROOT.require(a.prereq).then(function(){delete a.prereq;if(a.prereq_logdiv&&document){var b=document.getElementById(a.prereq_logdiv);b&&(b.innerHTML="");delete a.prereq_logdiv}return JSROOT.connectWebWindow(a)});var b=JSROOT.decodeUrl();b.has("headless")&&b.get("key")&&(JSROOT.browser.isChromeHeadless||
JSROOT.browser.isChrome)&&JSROOT.loadScript("root_batch_holder.js?key="+b.get("key"));a.platform||(a.platform=b.get("platform"));"qt5"==a.platform?JSROOT.browser.qt5=!0:"cef3"==a.platform&&(JSROOT.browser.cef3=!0);void 0===a.batch&&(a.batch=b.has("headless"));a.batch&&(JSROOT.batch_mode=!0);a.socket_kind||(a.socket_kind=b.get("ws"));a.socket_kind||(a.socket_kind=JSROOT.browser.qt5?"rawlongpoll":JSROOT.browser.cef3?"longpoll":"websocket");return new Promise(function(c){var d=new e(a.socket_kind,a.credits);
d.setUserArgs(a.user_args);a.href&&d.setHRef(a.href);window&&(window.onbeforeunload=function(){return d.close(!0)},JSROOT.browser.qt5&&(window.onqt5unload=window.onbeforeunload));d.key=b.get("key");d.token=b.get("token");a.first_recv&&(a.receiver={onWebsocketOpened:function(){},onWebsocketMsg:function(b,d){if(0!=d.indexOf(a.first_recv))return b.close();b.first_msg=d.substr(a.first_recv.length);a.prereq2||c(b)},onWebsocketClosed:function(){return JSROOT.Painter.closeCurrentWindow()}});if(!a.receiver)return c(d);
d.setReceiver(a.receiver);d.connect();a.prereq2?JSROOT.require(a.prereq2).then(function(){delete a.prereq2;a.first_recv&&!d.first_msg||c(d)}):a.first_recv||c(d)})};JSROOT.WebWindowHandle=e;return JSROOT});
