...
$jscomp.findInternal=function(f,b,n){f instanceof String&&(f=String(f));for(var l=f.length,m=0;m<l;m++){var r=f[m];if(b.call(n,r,m,f))return{i:m,v:r}}return{i:-1,v:void 0}};$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(f,b,n){f!=Array.prototype&&f!=Object.prototype&&(f[b]=n.value)};$jscomp.getGlobal=function(f){return"undefined"!=typeof window&&window===f?f:"undefined"!=typeof global&&null!=global?global:f};$jscomp.global=$jscomp.getGlobal(this);
...
"  fullname: "+a._fullname);p||(p=b);g.attr("title",p).text(b+("_value"in a?":":"")).style("background",a._background?a._background:null);"_value"in a&&(m=m.append("p"),"_vclass"in a&&m.attr("class",a._vclass),a._isopen||m.html(a._value));if(e&&(d||a._isopen))for(d=c.append("div").attr("class","h_childs"),this.show_overflow&&d.style("overflow","initial"),e=0;e<a._childs.length&&(c=a._childs[e],c._parent=a,this.addItemHtml(c,d,e));++e);return!0};l.prototype.toggleOpenState=function(a,c){var b=c||this.h;
if(void 0===b._childs){if(!a||this.with_icons&&!b._more&&!b._expand&&!this.canExpandItem(b))return!1;this.expandItem(this.itemFullName(b));void 0!==b._childs&&(b._isopen=!0);return b._isopen}if(b!==this.h&&a&&!b._isopen)return b._isopen=!0;for(var d=!1,h=0;h<b._childs.length;++h)this.toggleOpenState(a,b._childs[h])&&(d=!0);if(b!==this.h&&!a&&b._isopen&&!d)return delete b._isopen,!0;c||this.refreshHtml();return!1};l.prototype.refreshHtml=function(){var a=this,c=this.selectDom();if(c.empty())return Promise.resolve(this);
c.html("").style("overflow",this.show_overflow?"auto":"hidden").style("display","flex").style("flex-direction","column");var b=this,d=[],h=null;this.forEachItem(function(a){delete a._d3cont;"_fastcmd"in a&&"Command"==a._kind&&d.push(a);"_status"in a&&!h&&(h=a)});if(!this.h||c.empty())return Promise.resolve(this);if(d.length)for(var g=c.append("div").attr("class","jsroot"),k=0;k<d.length;++k){var t=g.append("button").text("").attr("class","fast_command").attr("item",this.itemFullName(d[k])).attr("title",
d[k]._title).on("click",function(){b.executeCommand(f.select(this).attr("item"),this)});"_icon"in d[k]&&t.append("img").attr("src",d[k]._icon)}g=c.append("p").attr("class","jsroot").style("margin-bottom","3px").style("margin-top",0);g.append("a").attr("class","h_button").text("open all").attr("title","open all items in the browser").on("click",function(){return a.toggleOpenState(!0)});g.append("text").text(" | ");g.append("a").attr("class","h_button").text("close all").attr("title","close all items in the browser").on("click",
function(){return a.toggleOpenState(!1)});"function"==typeof this.removeInspector&&(g.append("text").text(" | "),g.append("a").attr("class","h_button").text("remove").attr("title","remove inspector").on("click",function(){return a.removeInspector()}));"_online"in this.h&&(g.append("text").text(" | "),g.append("a").attr("class","h_button").text("reload").attr("title","reload object list from the server").on("click",function(){return a.reload()}));"disp_kind"in this&&(g.append("text").text(" | "),g.append("a").attr("class",
"h_button").text("clear").attr("title","clear all drawn objects").on("click",function(){return a.clearHierarchy(!1)}));c=c.append("div").attr("class","jsroot").style("font-size",this.with_icons?"12px":"15px").style("flex","1");this.show_overflow||c.style("overflow","auto");this.background&&c.style("background-color",this.background).style("margin","2px").style("padding","2px");this.addItemHtml(this.h,c.append("div").attr("class","h_tree"));this.setTopPainter();if(h&&!this.status_disabled&&!JSROOT.decodeUrl().has("nostatus")){var p=
JSROOT.findFunction(h._status);if("function"==typeof p)return this.createStatusLine().then(function(c){c&&p(c,a.itemFullName(h))})}return Promise.resolve(this)};l.prototype.updateTreeNode=function(a,c){if(void 0===c||c.empty()){c=f.select(a._d3cont?a._d3cont:null);var b=this.itemFullName(a);c.empty()&&(c=this.selectDom().select("[item='"+b+"']"));c.empty()&&"_cycle"in a&&(c=this.selectDom().select("[item='"+b+";"+a._cycle+"']"));if(c.empty())return}this.addItemHtml(a,c,"update");this.brlayout&&this.brlayout.adjustBrowserSize(!0)};
l.prototype.focusOnItem=function(a){var c=this;"string"==typeof a&&(a=this.findItem(a));var b=a?this.itemFullName(a):"";if(!b)return Promise.resolve(!1);for(var d=!1;a;)void 0===a._childs||a._isopen||(d=a._isopen=!0),a=a._parent;return(d?this.refreshHtml():Promise.resolve(!0)).then(function(){var a=c.selectDom().select("[item='"+b+"']");if(a.empty())return!1;a.node().scrollIntoView();return!0})};l.prototype.updateBackground=function(a,c){if(a&&a._d3cont){var b=f.select(a._d3cont);b.empty()||(b=b.select(".h_item"),
b.style("background",a._background?a._background:null),c&&a._background&&b.node().scrollIntoView(!1))}};l.prototype.tree_click=function(a,c,b){if(c){var d=f.select(c.parentNode.parentNode),e=d.attr("item"),g=e?this.findItem(e):null;if(g)if(g._break_point){delete g._break_point;this.addItemHtml(g,d,"update");e=g._parent;g=e._childs.indexOf(g);d=f.select(d.node().parentNode);if(0>g)return console.error("internal error");e._show_limit=2*(e._show_limit||JSROOT.settings.HierarchyLimit);for(g+=1;g<e._childs.length;++g){var k=
e._childs[g];k._parent=e;if(!this.addItemHtml(k,d,g))break}}else{k=g;for(var t=void 0;k&&void 0===(t=k._click_action);)k=k._parent;b&&""!=b||(b="item");var p=n.getDrawSettings(g._kind,"ROOT.TKey"==g._kind&&g._more?"noinspect":"");k=p.handle;if("icon"==b)e=null,"function"==typeof g._icon_click?e=g._icon_click:k&&"function"==typeof k.icon_click&&(e=k.icon_click),e&&e(g,this)&&this.updateTreeNode(g,d);else{"item"==b&&"_expand"in g&&!a.ctrlKey&&!a.shiftKey&&(b="plusminus");if("plusminus"==b&&!("_childs"in
g)&&g._more||"item"==b&&"expand"===t)return this.expandItem(e,d);if("item"==b){if("_player"in g)return this.player(e);if(k&&k.aslink)return window.open(e+"/");if(k&&k.execute)return this.executeCommand(e,c.parentNode);if(k&&k.ignore_online&&this.isOnlineItem(g))return;c=g._can_draw;b=g._more;t="expand"===this.default_by_click;var q="";a.shiftKey&&(q=k&&k.shift?k.shift:"inspect","inspect"===q&&k&&k.noinspect&&(q=""));k&&k.ctrl&&a.ctrlKey&&(q=k.ctrl);if(!q)for(a=g._parent;a;a=a._parent)if(a._painter){c=
!1;void 0===b&&(b=!1);break}g._childs&&(b=!1);void 0===c&&(c=p.draw);void 0===b&&(b=p.expand);c&&b&&!q&&(t||k&&"expand"===k.dflt||this.isItemDisplayed(e))&&(c=!1);c&&!q&&k&&k.dflt&&"expand"!==k.dflt&&(q=k.dflt);if(c)return this.display(e,q);if(b||t)return this.expandItem(e,d);if("string"===typeof g._kind&&0===g._kind.indexOf("ROOT.")&&p.inspect&&!1!==c)return this.display(e,"inspect");if(!g._childs||g===this.h)return}g._isopen?delete g._isopen:g._isopen=!0;this.updateTreeNode(g,d)}}}};l.prototype.tree_mouseover=
function(a,b){b=f.select(b.parentNode.parentNode).attr("item");var c=this.findItem(b);if(c){for(var d,h=c;h&&!d;)d=h._painter,h=h._parent;d&&"function"===typeof d.mouseOverHierarchy&&d.mouseOverHierarchy(a,b,c)}};l.prototype.direct_contextmenu=function(a,b){var c=this;a.preventDefault();var d=f.select(b.parentNode.parentNode).attr("item"),h=this.findItem(d);h&&"function"==typeof this.fill_context&&n.createMenu(a,this).then(function(a){c.fill_context(a,h);0<a.size()&&(a.tree_node=b.parentNode,a.show())})};
l.prototype.tree_contextmenu=function(a,b){function c(a){var b=document.createElement("div");b.innerHTML='<a href="'+a.split("&").join("&amp;").split("<").join("&lt;").split('"').join("&quot;")+'">x</a>';return b.firstChild.href}var d=this;a.preventDefault();var h=f.select(b.parentNode.parentNode).attr("item"),g=this.findItem(h);if(g){var k=this.getOnlineProp(h),t=this.getFileProp(h);n.createMenu(a,this).then(function(a){if(""!=h&&g._parent||"_jsonfile"in g)if(k)d.fillOnlineMenu(a,k,h);else{var e=
n.getDrawSettings(g._kind,"nosame");g._can_draw&&(e.opts||(e.opts=[""]),0>e.opts.indexOf("")&&e.opts.unshift(""));e.opts&&a.addDrawMenu("Draw",e.opts,function(a){return d.display(h,a)});if(t&&e.opts&&!t.localfile){var f=c(t.fileurl);0==f.indexOf(JSROOT.source_dir)&&(f=f.slice(JSROOT.source_dir.length));f=t.kind+"="+f;if(0<t.itemname.length){var p=t.itemname;0<=p.search(/\+| |,/)&&(p="'"+p+"'");f+="&item="+p}a.addDrawMenu("Draw in new tab",e.opts,function(a){return window.open(JSROOT.source_dir+"index.htm?nobrowser&"+
f+"&opt="+a)})}!e.expand||"_childs"in g||!g._more&&"_more"in g||a.add("Expand",function(){return d.expandItem(h)});"ROOT.TStyle"===g._kind&&a.add("Apply",function(){return d.applyStyle(h)})}else{var m=[],l="",w=0;e=function(){return 0<w++?"&":"?"};d.forEachRootFile(function(a){return m.push(a._file.fFullURL)});d.getTopOnlineItem()||(l=JSROOT.source_dir+"index.htm");d.isMonitoring()&&(l+=e()+"monitoring="+d.getMonitoringInterval());1==m.length?l+=e()+"file="+m[0]:1<m.length&&(l+=e()+"files="+JSON.stringify(m));
d.disp_kind&&(l+=e()+"layout="+d.disp_kind.replace(/ /g,""));var v=[],r=[];d.disp&&d.disp.forEachPainter(function(a){var b=a.getItemName();b&&(v.push(b),r.push(a.getDrawOpt()||a.getItemDrawOpt()))});1==v.length?l+=e()+"item="+v[0]+e()+"opt="+r[0]:1<v.length&&(l+=e()+"items="+JSON.stringify(v)+e()+"opt="+JSON.stringify(r));a.add("Direct link",function(){return window.open(l)});a.add("Only items",function(){return window.open(l+"&nobrowser")})}"function"==typeof g._menu&&g._menu(a,g,d);0<a.size()&&
(a.tree_node=b.parentNode,a.separ&&a.add("separator"),a.add("Close"),a.show())});return!1}};l.prototype.commandArgsDialog=function(a,c){var e=document.getElementById("jsroot_cmdargs_dialog");e&&e.parentNode.removeChild(e);e="";for(var d=0;d<c.length;++d)e+='<label for="jsroot_cmdargs_dialog_inp'+d+'">arg'+(d+1)+'</label>\n                    <input type="text" tabindex="0" name="jsroot_cmdargs_dialog_inp'+d+'" id="jsroot_cmdargs_dialog_inp'+d+'" value="'+c[d]+'" style="width:100%;display:block" class="text ui-widget-content ui-corner-all"/>';
b(document.body).append('<div id="jsroot_cmdargs_dialog">\n           <form>\n             <fieldset style="padding:0; border:0">\n                '+e+'\n                <input type="submit" tabindex="-1" style="position:absolute; top:-1000px; display:block"/>\n            </fieldset>\n           </form>\n         </div>');return new Promise(function(d){var e,h=function(){e="";for(var a=0;a<c.length;++a){var g=b("#jsroot_cmdargs_dialog_inp"+a).val();e+=0<a?"&":"?";e+="arg"+(a+1)+"="+g}f.dialog("close");
d(e)};var f=b("#jsroot_cmdargs_dialog").dialog({height:110+60*c.length,width:400,modal:!0,resizable:!0,title:"Arguments for command "+a,buttons:{Ok:h,Cancel:function(){f.dialog("close");d(!1)}},close:function(){f.remove();e||d(!1)}});f.find("form").on("submit",function(a){a.preventDefault();h()})})};l.prototype.createDisplay=function(){if("disp"in this){if(0<this.disp.numDraw())return Promise.resolve(this.disp);this.disp.cleanup();delete this.disp}if(!document.getElementById(this.disp_frameid))return Promise.resolve(null);
"tabs"==this.disp_kind?this.disp=new r(this.disp_frameid):0==this.disp_kind.indexOf("flex")?this.disp=new y(this.disp_frameid):0==this.disp_kind.indexOf("coll")?this.disp=new m(this.disp_frameid):this.disp=new JSROOT.GridDisplay(this.disp_frameid,this.disp_kind);this.disp&&(this.disp.cleanupFrame=this.cleanupFrame.bind(this));return Promise.resolve(this.disp)};l.prototype.enableDrag=function(a){b(a).draggable({revert:"invalid",appendTo:"body",helper:"clone"})};l.prototype.enableDrop=function(a,c){var e=
this;b(a).droppable({hoverClass:"ui-state-active",accept:function(a){a=a.parent().parent().attr("item");return a!=c&&a?(a=e.findItem(a))&&"_kind"in a?0==a._kind.indexOf("ROOT."):!1:!1},drop:function(a,c){(a=c.draggable.parent().parent().attr("item"))&&e.dropItem(a,b(this).attr("id"))}})};l.prototype.createBrowser=function(a,c){var e=this;if(!this.gui_div||this.exclude_browser||!this.brlayout)return Promise.resolve(!1);var d=f.select("#"+this.gui_div+" .jsroot_browser"),h=b(d.node());if(d.empty())return Promise.resolve(!1);
"float"===a&&this.float_browser_disabled&&(a="fix");if(!d.select(".jsroot_browser_area").empty())return c&&this.brlayout.toggleKind(a),Promise.resolve(!0);var g="<p class='jsroot_browser_version'><a href='https://root.cern/js/'>JSROOT</a> version <span style='color:green'><b>"+JSROOT.version+"</b></span></p>";if(this.is_online)g+='<p> Hierarchy in <a href="h.json">json</a> and <a href="h.xml">xml</a> format</p><div style="display:inline-block;"><label style="margin-right:5px; vertical-align:middle;"><input style="vertical-align:middle;" type="checkbox" name="monitoring" class="gui_monitoring"/>Monitoring</label>';
...
!this.no_select||"file"==this.no_select)g+='<select style="padding:2px;margin-right:5px;" title="layout kind" class="gui_layout"></select></div>';g+='<div id="'+this.gui_div+'_browser_hierarchy" class="jsroot_browser_hierarchy"></div>';this.brlayout.setBrowserContent(g);this.is_online?this.brlayout.setBrowserTitle("ROOT online server"):this.brlayout.setBrowserTitle("Read a ROOT file");var q=null;this.is_online||this.no_select||(this.ReadSelectedFile=function(){var a=d.select(".gui_urlToLoad").property("value").trim();
a&&(a.toLowerCase().lastIndexOf(".json")==a.length-5?this.openJsonFile(a):this.openRootFile(a))},h.find(".gui_selectFileName").val("").change(function(){h.find(".gui_urlToLoad").val(b(this).val())}),h.find(".gui_fileBtn").button().click(function(){return h.find(".gui_localFile").click()}),h.find(".gui_ReadFileBtn").button().click(function(){return e.ReadSelectedFile()}),h.find(".gui_ResetUIBtn").button().click(function(){return e.clearHierarchy(!0)}),h.find(".gui_urlToLoad").keyup(function(a){13==
a.keyCode&&e.ReadSelectedFile()}),h.find(".gui_localFile").change(function(a){a=a.target.files;for(var b=0;b<a.length;++b){var c=a[b];d.select(".gui_urlToLoad").property("value",c.name);e.openRootFile(c).then(q)}q=null}),this.selectLocalFile=function(){var a=this;return new Promise(function(c){q=c;b("#"+a.gui_div+" .jsroot_browser").find(".gui_localFile").click()})});k=h.find(".gui_layout");if(k.length){l="simple;vert2;vert3;vert231;horiz2;horiz32;flex;grid 2x2;grid 1x3;grid 2x3;grid 3x3;grid 4x4;collapsible;tabs".split(";");
for(var u=0;u<l.length;++u){var n=document.createElement("option");n.value=l[u];n.innerHTML=l[u];k.get(0).appendChild(n)}var r=this;k.change(function(){r.setDisplay(b(this).val()||"collapsible",r.gui_div+"_drawing")})}this.setDom(this.gui_div+"_browser_hierarchy");c&&(this.refreshHtml(),this.initializeBrowser());this.brlayout.toggleBrowserKind(a||"fix");return Promise.resolve(!0)};l.prototype.initializeBrowser=function(){var a=f.select("#"+this.gui_div+" .jsroot_browser");if(!a.empty()&&this.brlayout){var c=
b(a.node());this.brlayout&&this.brlayout.adjustBrowserSize();if(a=a.select(".gui_layout").node()){var e=!1;for(h in a.options){var d=a.options[h].text;if("string"===typeof d&&(d==this.getLayout()||d.replace(/ /g,"")==this.getLayout())){a.selectedIndex=h;e=!0;break}}if(!e){var h=document.createElement("option");h.innerHTML=h.value=this.getLayout();a.appendChild(h);a.selectedIndex=a.options.length-1}}if(this.is_online){this.h&&this.h._toptitle&&this.brlayout.setBrowserTitle(this.h._toptitle);var g=
this;c.find(".gui_monitoring").prop("checked",this.isMonitoring()).click(function(){g.enableMonitoring(this.checked);g.updateItems()})}else if(!this.no_select){var k="";this.forEachRootFile(function(a){k||(k=a._fullurl)});c.find(".gui_urlToLoad").val(k)}}};l.prototype.enableMonitoring=function(a){this.setMonitoring(void 0,a);var b=f.select("#"+this.gui_div+" .jsroot_browser .gui_monitoring");b.empty()||b.property("checked")===a||b.property("checked",a)};JSROOT.buildGUI=function(a,b){var c="string"==
typeof a?f.select("#"+a):f.select(a);if(c.empty())return alert("no div for gui found");var d=!1;"online"==b&&(d=!0);"true"===c.attr("ignoreurl")&&(JSROOT.settings.IgnoreUrlOptions=!0);if(JSROOT.decodeUrl().has("nobrowser")||c.attr("nobrowser")&&"false"!==c.attr("nobrowser")||"draw"==b||"nobrowser"==b)return JSROOT.buildNobrowserGUI(a,b);n.readStyleFromURL();var h=new JSROOT.HierarchyPainter("root",null);h.is_online=d;return h.startGUI(c).then(function(){h.initializeBrowser();return h})};var m=function(a){a=
JSROOT.MDIDisplay.call(this,a)||this;a.cnt=0;return a};$jscomp.inherits(m,JSROOT.MDIDisplay);m.prototype.forEachFrame=function(a,c){var e=this.frameid+"_collapsible";document.getElementById(e)&&"function"==typeof a&&b("#"+e+" .collapsible_draw").each(function(){c&&b(this).is(":hidden")||a(b(this).get(0))})};m.prototype.getActiveFrame=function(){var a=JSROOT.MDIDisplay.prototype.getActiveFrame.call(this);if(a&&!b(a).is(":hidden"))return a;a=null;this.forEachFrame(function(b){a||(a=b)},!0);return a};
m.prototype.activateFrame=function(a){b(a).is(":hidden")&&b(a).prev().toggleClass("ui-accordion-header-active ui-state-active ui-state-default ui-corner-bottom").find("> .ui-icon").toggleClass("ui-icon-triangle-1-e ui-icon-triangle-1-s").end().next().toggleClass("ui-accordion-content-active").slideDown(0);b(a).prev()[0].scrollIntoView();this.active_frame_title=f.select(a).attr("frame_title")};m.prototype.createFrame=function(a){this.beforeCreateFrame(a);var c=this.frameid+"_collapsible";document.getElementById(c)||
b("#"+this.frameid).append('<div id="'+c+'" class="jsroot ui-accordion ui-accordion-icons ui-widget ui-helper-reset" style="overflow:auto; overflow-y:scroll; height:100%; padding-left: 2px; padding-right: 2px"></div>');var e=this,d=c+"_sub"+this.cnt++,h=d+"h",g='<h5 id="'+h+"\"><span class='ui-icon ui-icon-triangle-1-e'></span><a> "+a+"</a>&nbsp; <button type='button' class='jsroot_collaps_closebtn' style='float:right; width:1.4em' title='close canvas'/> </h5>\n<div class='collapsible_draw' id='"+
d+"'></div>\n";b("#"+c).append(g);b("#"+h).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-top ui-corner-bottom").hover(function(){b(this).toggleClass("ui-state-hover")}).click(function(){b(this).toggleClass("ui-accordion-header-active ui-state-active ui-state-default ui-corner-bottom").find("> .ui-icon").toggleClass("ui-icon-triangle-1-e ui-icon-triangle-1-s").end().next().toggleClass("ui-accordion-content-active").slideToggle(0);var a=b(this).next(),c=a.is(":hidden");a.css("display",
c?"none":"");c||JSROOT.resize(a.get(0))}).next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom").hide();b("#"+h).find(" .jsroot_collaps_closebtn").button({icons:{primary:"ui-icon-close"},text:!1}).click(function(){e.cleanupFrame(b(this).parent().next().attr("id"));b(this).parent().next().remove();b(this).parent().remove()});b("#"+h).toggleClass("ui-accordion-header-active ui-state-active ui-state-default ui-corner-bottom").find("> .ui-icon").toggleClass("ui-icon-triangle-1-e ui-icon-triangle-1-s").end().next().toggleClass("ui-accordion-content-active").slideToggle(0);
return b("#"+d).attr("frame_title",a).css("overflow","hidden").attr("can_resize","height").css("position","relative").get(0)};var r=function(a){a=JSROOT.MDIDisplay.call(this,a)||this;a.cnt=0;return a};$jscomp.inherits(r,JSROOT.MDIDisplay);r.prototype.forEachFrame=function(a,c){var e=this.frameid+"_tabs";if(document.getElementById(e)&&"function"==typeof a){var d=-1,h=b("#"+e).tabs("option","active");b("#"+e+"> .tabs_draw").each(function(){d++;c&&d!=h||a(b(this).get(0))})}};r.prototype.getActiveFrame=
function(){var a=null;this.forEachFrame(function(b){a||(a=b)},!0);return a};r.prototype.activateFrame=function(a){var c=0,e=-1;this.forEachFrame(function(d){b(d).attr("id")==b(a).attr("id")&&(e=c);c++});b("#"+this.frameid+"_tabs").tabs("option","active",e);this.active_frame_title=f.select(a).attr("frame_title")};r.prototype.createFrame=function(a){this.beforeCreateFrame(a);var c=this,e=this.frameid+"_tabs",d=e+"_sub"+this.cnt++,h='<li><a href="#'+d+'">'+a+'</a><span class="ui-icon ui-icon-close" style="float: left; margin: 0.4em 0.2em 0 0; cursor: pointer;" role="presentation">Remove Tab</span></li>',
